...
import { CONNECTION_PICKER_OPTIONS, CONNECTION_PROFILES, CONNECTION_PROFILE_ICONS, type ConnectionProfileCategory, type ConnectionProfileDefinition } from "@/types/generated/connectionProfiles";
...
type DbOption = { value: string; label: string; category?: ConnectionProfileCategory; plugin?: boolean; pluginId?: string; pluginIcon?: string };
